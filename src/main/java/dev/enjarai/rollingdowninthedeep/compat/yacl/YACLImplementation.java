        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(getOption(Double.class, "general.strafing", "yaw_strength", false, false)
                        .controller(option -> getDoubleSlider(option, 0.0, 30, 0.05))
                        .binding(0.0, () -> SwimConfig.INSTANCE.strafeYawStrength, value -> SwimConfig.INSTANCE.strafeYawStrength = value)
                        .build())
                    .option(getOption(Double.class, "general.strafing", "roll_strength", false, false)
                        .controller(option -> getDoubleSlider(option, 0.0, 30, 0.05))
                        .binding(5.6, () -> SwimConfig.INSTANCE.strafeRollStrength, value -> SwimConfig.INSTANCE.strafeRollStrength = value)
                        .build())
                    .option(getBooleanOption("general.strafing", "do_strafe", true, false)
                        .binding(false, () -> SwimConfig.INSTANCE.strafeDoStrafe, value -> SwimConfig.INSTANCE.strafeDoStrafe = value)
                        .build())
                    .build())
                .group(OptionGroup.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(getBooleanOption("smoothing", "enabled", false, false)
                    .binding(false, () -> SwimConfig.INSTANCE.smoothing.smoothingEnabled, value -> SwimConfig.INSTANCE.smoothing.smoothingEnabled = value)
                    .build())
                .option(getBooleanOption("smoothing", "strafe_enabled", false, false)
                    .binding(false, () -> SwimConfig.INSTANCE.smoothing.strafeSmoothingEnabled, value -> SwimConfig.INSTANCE.smoothing.strafeSmoothingEnabled = value)
                    .build())
                .group(OptionGroup.createBuilder()
